...
function getNextPageSlugForRedirect() {
  const normalize = (value) => {
    if (!value) return "";
    return value.startsWith("/698fa8d95dfb37cbef9148a5-preview") ? value : (value.startsWith("/") ? "/698fa8d95dfb37cbef9148a5-preview" + value : "/698fa8d95dfb37cbef9148a5-preview/" + value);
  };
...
const DEFAULT_OFFER_ID = '243';
const getVrioOfferInfoByProductId = (productId) =>
  ((productId) => {
    const vrioOffers = [{"id":243,"offerTypeId":1,"name":"Melo Slim - Network","items":[{"name":"1 Month Supply (30 Patches) - Melo Slim","id":1721,"quantity":1,"price":0,"shippable":false},{"name":"3 Month Supply (90 Patches) - Melo Slim","id":1722,"quantity":1,"price":0,"shippable":false},{"name":"6 Month Supply (180 Patches) - Melo Slim","id":1723,"quantity":1,"price":0,"shippable":false},{"name":"Melo Slim","id":1720,"quantity":1,"price":0,"shippable":true},{"name":"Melo Slim  Journey Package Protection","id":1725,"quantity":1,"price":0,"shippable":false},{"name":"Melo Slim - 3 Year Warranty","id":1724,"quantity":1,"price":0,"shippable":false},{"name":"Special 1x EXTRA 1 Month Supply (30 Patches) - Melo Slim","id":1726,"quantity":1,"price":0,"shippable":false}]},{"id":244,"offerTypeId":2,"name":"Melo Slim - VIP","items":[{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":14.99,"shippable":false}]}];
...
const getPrices = () => {
  return [{"name":"1 Month Supply (30 Patches) - Melo Slim","id":1721,"quantity":1,"price":0,"shippable":false,"fullPrice":39.99,"finalPrice":39.99,"productName":"1 Month Supply (30 Patches) - Melo Slim","discountAmount":0,"discountPercentage":0},{"name":"3 Month Supply (90 Patches) - Melo Slim","id":1722,"quantity":1,"price":0,"shippable":false,"fullPrice":78.73,"finalPrice":78.73,"productName":"3 Month Supply (90 Patches) - Melo Slim","discountAmount":0,"discountPercentage":0},{"name":"6 Month Supply (180 Patches) - Melo Slim","id":1723,"quantity":1,"price":0,"shippable":false,"fullPrice":149.94,"finalPrice":149.94,"productName":"6 Month Supply (180 Patches) - Melo Slim","discountAmount":0,"discountPercentage":0},{"name":"Melo Slim  Journey Package Protection","id":1725,"quantity":1,"price":0,"shippable":false,"fullPrice":3.5,"finalPrice":3.5,"productName":"Melo Slim  Journey Package Protection","discountAmount":0,"discountPercentage":0},{"name":"Melo Slim - 3 Year Warranty","id":1724,"quantity":1,"price":0,"shippable":false,"fullPrice":9.95,"finalPrice":9.95,"productName":"Melo Slim - 3 Year Warranty","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA 1 Month Supply (30 Patches) - Melo Slim","id":1726,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Special 1x EXTRA 1 Month Supply (30 Patches) - Melo Slim","discountAmount":0,"discountPercentage":0},{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":14.99,"shippable":false,"fullPrice":14.99,"finalPrice":14.99,"productName":"VIP Customer Benefits","discountAmount":0,"discountPercentage":0}]
};
...
const shippables = [{"id":1720,"name":"Melo Slim"}];
...
async function createOrderViaWallet(confirmationToken, paymentMethodId) {
  ...
  const orderData = {
    pageId: "46hLI4ALAC2mLPPfGf80sxjY8Un6U9tk74F3cxLG-sIflhyyyQihhs-FMU_5UV6g",
    action: "process",
...
const getStates = async (countryIso2Code) => {
  ...
  try {
    if (!countriesStatesCache) {
      const res = await fetch('/698fa8d95dfb37cbef9148a5-preview/scripts/countriesData/countriesStates.json', { cache: 'no-store' });
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      data: { pageName: "MS-Checkout-v1", pageType: "Checkout" },
    };
