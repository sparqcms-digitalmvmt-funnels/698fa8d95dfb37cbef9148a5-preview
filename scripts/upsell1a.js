...
const prices = [{"name":"1 Month Supply (30 Patches) - Melo Slim","id":1721,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"1 Month Supply (30 Patches) - Melo Slim","discountAmount":0,"discountPercentage":0},{"name":"3 Month Supply (90 Patches) - Melo Slim","id":1722,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"3 Month Supply (90 Patches) - Melo Slim","discountAmount":0,"discountPercentage":0},{"name":"6 Month Supply (180 Patches) - Melo Slim","id":1723,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"6 Month Supply (180 Patches) - Melo Slim","discountAmount":0,"discountPercentage":0},{"name":"Melo Slim  Journey Package Protection","id":1725,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Melo Slim  Journey Package Protection","discountAmount":0,"discountPercentage":0},{"name":"Melo Slim - 3 Year Warranty","id":1724,"quantity":1,"price":0,"shippable":false,"fullPrice":0,"finalPrice":0,"productName":"Melo Slim - 3 Year Warranty","discountAmount":0,"discountPercentage":0},{"name":"Special 1x EXTRA 1 Month Supply (30 Patches) - Melo Slim","id":1726,"quantity":1,"price":0,"shippable":false,"fullPrice":19.99,"finalPrice":19.99,"productName":"Special 1x EXTRA 1 Month Supply (30 Patches) - Melo Slim","discountAmount":0,"discountPercentage":0},{"name":"VIP Customer Benefits","id":26,"quantity":1,"price":14.99,"shippable":false,"fullPrice":14.99,"finalPrice":14.99,"productName":"VIP Customer Benefits","discountAmount":0,"discountPercentage":0}];
    ...
    const response = await fetch(
      `https://app-cms-api-proxy-prod-001.azurewebsites.net/vrio/order_offers`,
      {
        ...
        body: JSON.stringify({
          ...
          order_id: lastOrderId,
          pageId: "xU4-LiE23PAKubKvd9F-Zg1JuEQMBmBS3vR6q8vtB2j863xXsym_zaehAoxUos54"
        })
      }
    );
...
const processUpsell = async () => {
  ...
  try {
    const orderData = JSON.parse(sessionStorage.getItem("orderData"));
    orderData.pageId = "xU4-LiE23PAKubKvd9F-Zg1JuEQMBmBS3vR6q8vtB2j863xXsym_zaehAoxUos54";
    const lastOrderId = sessionStorage.getItem("cms_oid");
...
if (typeof validateAndSendToKlaviyo === "function") {
  try {
    ...
    var pageReadyPayload = {
      ...
      data: { pageName: "MS-Upsell1-V1", pageType: "Upsell" },
    };
